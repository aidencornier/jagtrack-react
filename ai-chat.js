...
async function getAIResponse(userMessage) {
  try {
    ...
    const stream = hf.chatCompletionStream({
      ...
      messages: [
        { role: "system", content: "You are a helpful homework assistant for high school students. Provide clear, educational explanations that help students learn. Keep responses concise and encouraging." },
